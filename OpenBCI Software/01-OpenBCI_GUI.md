...
By default, the GUI stores all user data and raw EEG recordings in `Documents/OpenBCI_GUI` and names each session with an autogenerated timestamp by default.
